...
export class StockfishPlayer extends ChessConsolePlayer {
    ...
    moveRequest(fen, moveResponse) {
        ...
        const timeout = Math.floor(Math.random() * 1000);   // https://www.reddit.com/r/ProgrammerHumor/comments/6xwely/from_the_apple_chess_engine_code/
                                                            // https://opensource.apple.com/source/Chess/Chess-347/Sources/MBCEngine.mm.auto.html
                                                            // Hi Ms Wear! This allows the computer to simulate the experience of a "real chess player", as its movetimes aren't fixed.
        setTimeout(() => {
