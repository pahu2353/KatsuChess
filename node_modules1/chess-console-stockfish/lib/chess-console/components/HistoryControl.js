...
import {Observe} from "../../cm-web-modules/observe/Observe.js"
...
export class HistoryControl extends Component {
    constructor(chessConsole) {
        ...
        i18n.load({
            ...
            en: {
                "to_game_start": "Starting Position",
                "one_move_back": "Move Backwards",
                "one_move_forward": "Move Forwards",
                "to_last_move": "Final Position",
                "auto_run": "Auto Play",
                "turn_board": "Flip Board"
            }
        }).then(() => {
